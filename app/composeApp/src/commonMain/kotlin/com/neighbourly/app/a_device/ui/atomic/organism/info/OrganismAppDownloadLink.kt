    ...
    Column(
        ...
        Image(
            painter = BitmapPainter(
                generateQrCode(
                    "https://neighbourlybox.com/releases/neighbourly-" + appVersion + ".apk",
                    600
                )
            ),
        ...
        FriendlyText(
            modifier = Modifier.clickable {
                uriHandler.openUri("https://neighbourlybox.com/releases/")
            },
            text = "https://neighbourlybox.com/releases/",
            fontSize = 22.sp,
            bold = true,
        )
    }
