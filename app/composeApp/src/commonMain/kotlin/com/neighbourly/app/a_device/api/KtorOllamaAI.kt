...
import com.neighbourly.app.b_adapt.gateway.ai.AIResponseOllama
import com.neighbourly.app.b_adapt.gateway.ai.GenerateInputOllama
...
object KtorOllamaAI {
    ...
    suspend fun generate(
        generateInput: GenerateInputOllama,
    ): AIResponseOllama {
        ...
        if (response.status.value == 200) {
            return response.body<AIResponseOllama>()
        } else {
