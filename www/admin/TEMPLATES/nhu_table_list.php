...
<div class="LIST_CONT">
	<?php if(isset($listitems))for($listitems_counter=0;$listitems_counter < countOrZero($listitems);$listitems_counter ++) { ?>
		<div class="TAB">					
			<div class="TAB_TITLE">					
				<?php echo "Neigh[" . $listitems[$listitems_counter]['numerics_0'] . "], House[" . $listitems[$listitems_counter]['numerics_1'] . "], User[" . $listitems[$listitems_counter]['numerics_2'] . "] :: " . $listitems[$listitems_counter]['numerics_3']; ?>
			</div>			
