...
<link rel="stylesheet" type="text/css" href="CSS/TPL_table_list_high.css" />
...
<div class="LIST_CONT">
	<?php if(isset($listitems))for($listitems_counter=0;$listitems_counter < countOrZero($listitems);$listitems_counter ++) { ?>
		<div class="TAB">
			...
			<div class="TAB_IMG">
				<?php if($has_pic) { ?>										
					<img src="thumb.php?img_tip=12&img_url=<?php echo $listitems[$listitems_counter]['pic']; ?>" class="TAB_IMAGE" />
				<?php } else { ?>
				<?php } ?>			
			</div>
		</div>			
