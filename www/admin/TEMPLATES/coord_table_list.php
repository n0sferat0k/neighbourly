...
<div class="LIST_CONT">
	<?php if(isset($listitems))for($listitems_counter=0;$listitems_counter < countOrZero($listitems);$listitems_counter ++) { ?>
		<div class="TAB">			
			<div class="TAB_TITLE">
				<?php echo $listitems[$listitems_counter]['numerics'][0]; ?>
				-
				[<?php echo $listitems[$listitems_counter]['numerics'][1] / 1000000; ?>,<?php echo $listitems[$listitems_counter]['numerics'][2] / 1000000; ?>]
			</div>						
			<div class="TAB_OPS">		
